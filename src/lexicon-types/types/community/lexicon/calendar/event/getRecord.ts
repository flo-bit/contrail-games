...
const _appBskyActorProfileSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecord#appBskyActorProfile",
    ),
  ),
  /**
...
const _hydrateRsvpsSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecord#hydrateRsvps",
    ),
  ),
  get going() {
    return /*#__PURE__*/ v.optional(
...
const _hydrateRsvpsRecordSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecord#hydrateRsvpsRecord",
    ),
  ),
...
const _mainSchema = /*#__PURE__*/ v.query(
  "community.lexicon.calendar.event.getRecord",
  {
    ...
    output: {
      ...
      schema: /*#__PURE__*/ v.object({
         ...
         */
        rsvpsInterestedCount: /*#__PURE__*/ v.optional(
          /*#__PURE__*/ v.integer(),
        ),
        /**
...
const _profileEntrySchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal(
      "community.lexicon.calendar.event.getRecord#profileEntry",
    ),
  ),
  cid: /*#__PURE__*/ v.optional(/*#__PURE__*/ v.string()),
...
declare module "@atcute/lexicons/ambient" {
  interface XRPCQueries {
    "community.lexicon.calendar.event.getRecord": mainSchema;
  }
}
