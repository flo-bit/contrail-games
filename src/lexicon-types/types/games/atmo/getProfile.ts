...
const _appBskyActorProfileSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("games.atmo.getProfile#appBskyActorProfile"),
  ),
  /**
...
const _mainSchema = /*#__PURE__*/ v.query("games.atmo.getProfile", {
...
const _profileEntrySchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("games.atmo.getProfile#profileEntry"),
  ),
...
declare module "@atcute/lexicons/ambient" {
  interface XRPCQueries {
    "games.atmo.getProfile": mainSchema;
  }
}
