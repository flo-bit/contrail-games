...
const _collectionStatsSchema = /*#__PURE__*/ v.object({
  $type: /*#__PURE__*/ v.optional(
    /*#__PURE__*/ v.literal("rsvp.atmo.admin.getOverview#collectionStats"),
  ),
  collection: /*#__PURE__*/ v.string(),
  records: /*#__PURE__*/ v.integer(),
  unique_users: /*#__PURE__*/ v.integer(),
});
const _mainSchema = /*#__PURE__*/ v.query("rsvp.atmo.admin.getOverview", {
  params: null,
  output: {
    type: "lex",
...
declare module "@atcute/lexicons/ambient" {
  interface XRPCQueries {
    "rsvp.atmo.admin.getOverview": mainSchema;
  }
}
